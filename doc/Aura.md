...
```bash
cp .env.ini .env                                                  # set your LLM provider, model, and API key
...
Prefer a browser? Open <http://localhost:0000> to chat in LibreChat, or <http://localhost:6006> to inspect traces in Phoenix.
